...
| Mounting | **3 × M3 NPTH** at (43.1, 76.4), (80.9, 76.4), (80.9, 49.6) — 1.6 mm edge clearance each |
...
4. **Fix the duplicate `H1` reference designator** — two mounting-hole footprints share it. No fab impact; errors on netlist generation.
